...
class FaceRecognition(object):
    ...
    def galleryClear(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FaceRecognition/galleryClear',
            faro_dot_proto_dot_face__service__pb2.GalleryClearRequest.SerializeToString,
            faro_dot_proto_dot_face__service__pb2.GalleryInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def faceList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FaceRecognition/faceList',
            faro_dot_proto_dot_face__service__pb2.FaceListRequest.SerializeToString,
            faro_dot_proto_dot_face__service__pb2.FaceRecordList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
