...
_FACELISTREQUEST = _descriptor.Descriptor(
  name='FaceListRequest',
  full_name='FaceListRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gallery_name', full_name='FaceListRequest.gallery_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GALLERYCLEARREQUEST = _descriptor.Descriptor(
  name='GalleryClearRequest',
  full_name='GalleryClearRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='GalleryClearRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['FaceListRequest'] = _FACELISTREQUEST
DESCRIPTOR.message_types_by_name['GalleryClearRequest'] = _GALLERYCLEARREQUEST
...
FaceListRequest = _reflection.GeneratedProtocolMessageType('FaceListRequest', (_message.Message,), dict(
  DESCRIPTOR = _FACELISTREQUEST,
  __module__ = 'faro.proto.face_service_pb2'
  # @@protoc_insertion_point(class_scope:FaceListRequest)
  ))
_sym_db.RegisterMessage(FaceListRequest)

GalleryClearRequest = _reflection.GeneratedProtocolMessageType('GalleryClearRequest', (_message.Message,), dict(
  DESCRIPTOR = _GALLERYCLEARREQUEST,
  __module__ = 'faro.proto.face_service_pb2'
  # @@protoc_insertion_point(class_scope:GalleryClearRequest)
  ))
_sym_db.RegisterMessage(GalleryClearRequest)
...
_FACERECOGNITION = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='galleryClear',
    full_name='FaceRecognition.galleryClear',
    index=10,
    containing_service=None,
    input_type=_GALLERYCLEARREQUEST,
    output_type=_GALLERYINFO,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
    name='faceList',
    full_name='FaceRecognition.faceList',
    index=11,
    containing_service=None,
    input_type=_FACELISTREQUEST,
    output_type=_FACERECORDLIST,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
