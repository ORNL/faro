...
#Python
python -m grpc_tools.protoc --python_out=src --grpc_python_out=src --proto_path=proto faro/proto/image.proto faro/proto/geometry.proto faro/proto/face_service.proto 
